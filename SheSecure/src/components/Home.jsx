...
//               className="text-gray-700 font-semibold hover:text-blue-600 cursor-pointer"
//             >
//               Home
//             </button>
//             <button
...
//           <a
//             href="/signup"
//             className="mt-6 mx-auto md:mx-0 bg-pink-600 text-white px-6 py-3 rounded-2xl text-lg hover:bg-pink-700 transition-all"
//           >
//             Get Started
//           </a>
//         </div>
...
//     },
//     {
//       icon: <PhoneCall className="w-8 h-8 text-pink-600" />,
//       title: "One-Tap SOS",
...
//             <div
//               key={index}
//               className="p-6 bg-pink-50 rounded-2xl shadow-sm hover:shadow-md transition"
//             >
...
//       image: "src/assets/locationTrack.png",
//     },
//     {
...
//       image: "src/assets/Guidance Background Removed.png",
//     },
//   ];
...
//                 bg-white rounded-2xl shadow-md p-6 transition duration-300 
//                 hover:shadow-xl hover:scale-[1.01]
//                 ${index % 2 === 1 ? "md:flex-row-reverse" : ""}`}
//             >
//               {/* Image */}
//               <div className="md:w-1/2  rounded-2xl p-6">
//                 <img
//                   src={feature.image}
//                   alt={feature.title}
...
//               {/* Divider */}
//               <div className="hidden md:block w-[1px] bg-gray-800 h-60"></div>

//               {/* Text */}
//               <div className="md:w-1/2">
//                 <span className="bg-pink-100 rounded-full px-4 py-2 font-semibold">
//                   {feature.top}
//                 </span>
//                 <h3 className="mt-3 text-3xl font-semibold text-gray-800 mb-4 text-left">
//                   {feature.title}
//                 </h3>
...
//     >
//       <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-xl p-10 md:p-16 text-center transition-all duration-300 hover:shadow-2xl">
//         <h2 className="text-4xl font-extrabold text-red-500 mb-6 tracking-tight">
...
//         </p>
//         <p className="text-md text-gray-600 max-w-3xl mx-auto animate-fade-in delay-100">
...
//                 <div className="mx-auto h-80 w-[75%]">
//                   <img
//                     src="src/assets/_vision-Picsart-BackgroundChanger.png"
...
//         <h2 className="text-3xl font-bold text-center mb-12 bg-black bg-clip-text text-transparent">
...
//               className="flex-shrink-0 w-4/5 sm:w-1/2 md:w-1/3 bg-white rounded-lg shadow-md border border-gray-200 snap-center"
//               style={{
//                 minWidth: "280px",
//                 maxWidth: "350px",
//                 height: "240px",
...
//             className="bg-pink-600 text-white px-6 py-3 rounded-md hover:bg-pink-700 transition disabled:opacity-70 disabled:cursor-not-allowed cursor-pointer"
//           >
...
//         {/* Brand Info */}
//         <div>
//           <h3 className="text-2xl font-bold text-pink-500 mb-4">SheSecure</h3>
              ...
              <div className="p-6 h-full flex flex-col">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <img
                    src={logo1}
                    alt="SheSecure Logo"
                    className="h-8 sm:h-12 w-auto transition-transform duration-300 hover:scale-110"
                  />
                </div>
